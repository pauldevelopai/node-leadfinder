...
const TOOLS = [
  {
    name: 'search_leads',
    description: 'The call list: companies actively bidding on and winning public work, ranked by fit against your criteria. Filter by CIDB grade band (6+ / 2-5 / 1 — the territory split), routing band (green/amber/red), or a name search. Existing clients are suppressed. Each result carries the evidence behind its ranking.',
  ...
  {
    name: 'get_company',
    description: 'Everything on one company: score with per-component reasons, contacts, every signal with its evidence quote (award/bid, what, when, value), claim state, call-sheet history, and the outcome ladder so far.',
    inputSchema: { type: 'object', properties: {
