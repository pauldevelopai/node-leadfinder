...
async function toolSearchLeads(newsroomId, args) {
  ...
  return {
    counters: { found: k.found, already_clients: k.suppressed, returned: leads.length },
    presentation_hint: 'Give each lead its "why" in plain words. If several share a buyer/tender series, say so. For any unenriched lead the user cares about, research it with web search and save_profile BEFORE presenting — a bare list is a failure.',
    leads,
  };
}
